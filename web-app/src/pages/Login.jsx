  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      if (response.headers.get('content-type')?.includes('application/json')) {
        ...
        setOauthErrorMessage(data.message || 'Google Sign-In is not available. Please use email/password to sign in.');
      ...
      setOauthErrorMessage('Google Sign-In is not available. Please use email/password to sign in.');
      setShowOAuthErrorModal(true);
    }
  };
